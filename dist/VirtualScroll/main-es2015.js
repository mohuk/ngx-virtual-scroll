...
let NgxVScrollComponent = class NgxVScrollComponent {
    ...
    getHtmlElements() {
        ...
        const elementArray = Array.from(elementCollection);
...
let NgxVScrollService = class NgxVScrollService {
    constructor() { }
